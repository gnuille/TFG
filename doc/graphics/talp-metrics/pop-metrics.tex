...
\begin{tikzpicture}
  ...
  \filldraw[color=gray, fill=blue] (16, 0.5) rectangle (17.45, 1.95);
  \filldraw[color=gray, fill=red]  (16, 2.95) rectangle (17.45, 4.4);

  \node[anchor=west] at (17.6, 1.225) {\LARGE{Useful}};
  \node[anchor=west] at (17.6, 3.675) {\LARGE{Not-useful}};
