%------------------------------
%
%   FILE: Pop metrics decomposed
%   Author: Guillem Ramírez
%   Description: Graphic to show POP metrics decomposing not-useful
%     with communications (due to communication efficiency) and waiting
%     caused by load balance
%
%-----------------------------
